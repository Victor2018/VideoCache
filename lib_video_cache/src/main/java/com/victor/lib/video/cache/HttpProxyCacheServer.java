package com.victor.lib.video.cache;

import static com.victor.lib.video.cache.Preconditions.checkAllNotNull;
import static com.victor.lib.video.cache.Preconditions.checkNotNull;

import android.content.Context;
import android.net.Uri;
import android.util.Log;

import com.victor.lib.video.cache.file.DiskUsage;
import com.victor.lib.video.cache.file.FileNameGenerator;
import com.victor.lib.video.cache.file.Md5FileNameGenerator;
import com.victor.lib.video.cache.file.TotalCountLruDiskUsage;
import com.victor.lib.video.cache.file.TotalSizeLruDiskUsage;
import com.victor.lib.video.cache.headers.EmptyHeadersInjector;
import com.victor.lib.video.cache.headers.HeaderInjector;
import com.victor.lib.video.cache.sourcestorage.SourceInfoStorage;
import com.victor.lib.video.cache.sourcestorage.SourceInfoStorageFactory;
...
public class HttpProxyCacheServer {
    ...
    private HttpProxyCacheServer(Config config) {
        ...
        try {
            ...
            Log.e("","Proxy cache server started. Is it alive? " + isAlive());
    ...
    public void registerCacheListener(CacheListener cacheListener, String url) {
        ...
        synchronized (clientsLock) {
            try {
                ...
                Log.e("","Error registering cache listener", e);
            }
        }
    }
    ...
    private void waitForRequest() {
        try {
            while (!Thread.currentThread().isInterrupted()) {
                ...
                Log.e("","Accept new socket " + socket);
    ...
    private void processSocket(Socket socket) {
        try {
            ...
            Log.e("","Request to cache proxy:" + request);
            ...
            Log.e("","Closing socket… Socket is closed by client.");
        } catch (ProxyCacheException | IOException e) {
            onError(new ProxyCacheException("Error processing request", e));
        } finally {
            releaseSocket(socket);
            Log.e("","Opened connections: " + getClientsCount());
        }
    }
    ...
    private void closeSocketInput(Socket socket) {
        try {
            ...
            // There is no way to determine that client closed connection http://stackoverflow.com/a/10241044/999458
            // So just to prevent log flooding don't log stacktrace
            Log.e("","Releasing input stream… Socket is closed by client.");
        } catch (IOException e) {
    ...
    private void closeSocketOutput(Socket socket) {
        try {
            ...
            e.printStackTrace();
            Log.e("","Failed to close socket on proxy side: {}. It seems client have already closed connection.");
        }
    }
